...
void check_strlen()
{
	...
	char *alphabet = "abcdefghijklmnopqrstuvwxgsjoisihdgihsdoighfidghsjefopajoahfohngihaohfoahjfoafhiahfgahliashfilahiahlihkiahfishhyz";
...
void check_strcpy()
{
	...
	char *empty = "";
	char *hello_world = "Hello world !";
	char *alphabet = "abcdefghijklmnopqrs123456789dgsfrgfvihnfbihlsjvsljdfvojergoisocja;odjvoihfivhergdgfsegrs00";
	
	printf("\n================================\n");
	printf("========== FT_STRCPY ===========\n");
	printf("================================\n\n");
	printf("%-20s: \"%s\"\n", "char []", empty);
	printf("%-20s: buffer[140]\n", "copy to");
...
void check_write()
{
	...
	// printf("\n");
	printf("%-20s: \"%s\"\n", "char *", empty);
	printf("%-20s: \"Libc:%zu\"\n", "libc", write(0, empty, 0));
	// printf("\n");
	printf("%-20s: \"Libasm:%zu\"\n", "libasm", ft_write(0, empty, 0));
	printf("\n");
...
void check_strdup()
{
	char *text = " – my parents, my elder brother, my baby sister and me. First, meet my mum and dad, Jane and Michael. My mum enjoys reading and my dad enjoys playing chess with my brother    ";
	char *empty = "";
	char *save;
	char *save2;
